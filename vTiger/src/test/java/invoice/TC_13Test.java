...
import pomRepo.HomePage3;
import pomRepo.LoginPage;
public class TC_13Test extends BaseClass {
	@Test
	public void createInvoiceWith_InvalidCustomerNo() throws InterruptedException  {
		...
		double qty=ExcelLib.readNumberData("Sheet3", 4, 1);
		...
		HomePage3 homePage = new HomePage3(driver);
		explicitWait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath("//img[@title=\"Create Invoice...\"]")));
